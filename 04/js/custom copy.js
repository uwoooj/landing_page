...
var data = [
    ...
    [
        '<li class="swiper-slide"><a href=""><div class="img_wrap"><img src="./img/slam1.jpg"alt=""/><i class="sprite-12"></i></div><div class="txt_wrap"><strong class="tit">더 퍼스트 슬램덩크</strong><span class="percent">예매율 3.7%</span><em class="day">D-3</em></div><div class="btn_wrap"><a href="" class="tick">바로예매</a></div></a></li>',
...
$(function () {
    ...
    $(".even_nav a").on("click", function () {
        ...
        $(".swiper slide05").removeClass("on");

        $(".even_nav a:eq(" + num + ")").addClass("on");
        $("swiper slide05:eq(" + num + ")").addClass("on");
    });
